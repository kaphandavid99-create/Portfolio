...
export default function CTA() {
  return (
    <section id="services" className="max-w-7xl mx-auto px-4 sm:px-6 py-16 sm:py-24 text-center">
      ...
      {/* Services cards - spectacular cards matching project sizes */}
      <motion.div
            ...
            {[
              {
                ...
                image: '/web app.jpeg',
                description: 'I build responsive, scalable web applications with polished UI, modern architecture, and performance tuned experiences for both desktop and mobile users.',
              },
              {
                title: 'Graphic Design',
                image: '/graphic.jpeg',
                description: 'I create bold, memorable visual identities, marketing assets, and brand collateral that help businesses stand out and connect with their audience.',
              },
              {
                title: 'Website Maintenance',
                image: '/maintainance.jpeg',
                description: 'I keep websites secure, updated, and running smoothly with proactive monitoring, performance tuning, and continuous improvement.',
              },
              {
                title: 'Digital Marketing',
                image: '/digital.jpeg',
                description: 'I craft data-driven digital campaigns and content strategies that grow visibility, engagement, and conversions across modern channels.',
              },
            ].map((service, index) => (
              <motion.div
                key={service.title}
